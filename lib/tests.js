...
describe('01 The Math Object', function() {
  ...
  it('ceil should round numbers up', function() {

    dontCheatOn(ceil);
    expect(ceil(1.5)).to.equal(2);
    expect(ceil(-3.5)).to.equal(-3);
    expect(ceil(100)).to.equal(100);
    expect(ceil(-987)).to.equal(-987);
    expect(ceil(0)).to.equal(0);
    expect(ceil(-10003948302034.324)).to.equal(-10003948302034);
...
describe('04 Extra Credit', function() {
  ...
  it('parse should take a date string and return the milliseconds since January 1, 1970', function() {
    ...
    expect(parse('2016-03-31T01:27:00+06:00')).to.equal(1459366020000);
